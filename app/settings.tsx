  ...
  const sections: Section[] = [
    {
      ...
      items: [
        ...
        { icon: "AA", iconBg: "#EEF2FF", label: "Analytics",        sublabel: "Tx insights & spending",    type: "nav", onPress: () => router.push("/analytics"    as any) },
        { icon: "EA", iconBg: "#D1FAE5", label: "Earn / DeFi",      sublabel: "Yield & staking",           type: "nav", onPress: () => router.push("/earn"          as any) },
        { icon: "DA", iconBg: "#EFF6FF", label: "Connected dApps",  sublabel: "Manage dApp sessions",      type: "nav", onPress: () => router.push("/dapps"         as any) },
        { icon: "HW", iconBg: "#FEF3C7", label: "Hardware Wallet",  sublabel: "Ledger & Trezor",           type: "nav", onPress: () => router.push("/hardware"      as any) },
        { icon: "OP", iconBg: "#FDF2F8", label: "Options Trading",  sublabel: "DeFi options",             type: "nav", onPress: () => router.push("/options"        as any) },
        { icon: "PR", iconBg: "#FFF7ED", label: "Premium",          sublabel: "Upgrade your plan",         type: "nav", onPress: () => router.push("/premium"        as any) },
        { icon: "PA", iconBg: "#FFFBEB", label: "Price Alerts",     sublabel: "Token price notifications", type: "nav", onPress: () => router.push("/pricealerts"   as any) },
