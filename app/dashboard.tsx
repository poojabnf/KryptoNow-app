...
const sb = StyleSheet.create({
  ...
  navScroll:     { flex: 1, paddingHorizontal: 12, overflowY: "scroll" as any, maxHeight: "calc(100vh - 220px)" as any, scrollbarWidth: "thin" as any, scrollbarColor: "#6366F1 #EEF2FF" as any },
