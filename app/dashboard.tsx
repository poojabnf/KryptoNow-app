...
const NAV_ITEMS = [
  ...
  { label: "Analytics",      icon: "bar-chart-outline",        route: "/analytics",     active: false },
  { label: "Earn",           icon: "trending-up-outline",      route: "/earn",           active: false },
  { label: "Lock",           icon: "lock-closed-outline",      route: "/lock",           active: false },
  { label: "MFA",            icon: "shield-half-outline",      route: "/mfa",            active: false },
  { label: "Premium",        icon: "star-outline",             route: "/premium",        active: false },
