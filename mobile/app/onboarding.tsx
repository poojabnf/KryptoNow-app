...
export default function Onboarding() {
  ...
  async function handleFinish() {
    await updateProfile({ name, avatar: EMOJI[avatar] ?? avatar, defaultChain: chainId, currency, onboarded: true })
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              {step===1 && (
                <View style={s.stepContent}>
                  ...
                  <Text style={s.sub}>Your display name inside Kryptonow.</Text>
...
const s = StyleSheet.create({
  ...
  btnPrimaryWrap:   { borderRadius:18, overflow:'hidden', shadowColor:'#6366F1', shadowOffset:{width:0,height:6}, shadowOpacity:0.3, shadowRadius:14, elevation:8 },
