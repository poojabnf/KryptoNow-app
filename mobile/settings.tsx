    ...
    <View style={styles.c}>
      ...
      >
        ...
        <View style={[styles.profileCard, { backgroundColor: activeChain.color }]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.profileLabel}>Kypra Wallet</Text>
...
const styles = StyleSheet.create({
  ...
  profileCard:  { marginHorizontal: 16, marginBottom: 24, borderRadius: 20, padding: 18, flexDirection: 'row', alignItems: 'center', gap: 14, elevation: 5, ...Platform.select({ web:{ boxShadow:'0px 4px 12px rgba(0,0,0,0.15)' }, default:{ shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 12 } }) },
