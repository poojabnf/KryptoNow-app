...
import {
  ...
  Dimensions, ActivityIndicator, PanResponder, Platform,
} from 'react-native'
...
const s = StyleSheet.create({
  ...
  balanceCard:   { marginHorizontal: 16, marginBottom: 16, backgroundColor: '#6366F1', borderRadius: 24, padding: 24, alignItems: 'center', elevation: 8, ...Platform.select({ web:{ boxShadow:'0px 8px 20px rgba(99,102,241,0.3)' }, default:{ shadowColor: '#6366F1', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 20 } }) },
