...
export default function Dashboard() {
  ...
  return (
    <View style={s.c}>
      ...
      >
        {/* Balance card */}
        <View style={[s.card, { backgroundColor: activeChain.color, ...(Platform.OS === 'web' ? { boxShadow: `0px 8px 20px ${activeChain.color}88` } : { shadowColor: activeChain.color }) }]}>
...
const s = StyleSheet.create({
  ...
  card:        { marginHorizontal:16, marginBottom:16, borderRadius:24, padding:24, alignItems:'center', elevation:10, ...Platform.select({ web:{ boxShadow:'0px 8px 20px rgba(0,0,0,0.35)' }, default:{ shadowOffset:{width:0,height:8}, shadowOpacity:0.35, shadowRadius:20 } }) },
  ...
  ai:          { width:54, height:54, borderRadius:27, backgroundColor:'#fff', alignItems:'center', justifyContent:'center', borderWidth:2, elevation:3, ...Platform.select({ web:{ boxShadow:'0px 2px 8px rgba(100,116,139,0.12)' }, default:{ shadowColor:'#64748B', shadowOffset:{width:0,height:2}, shadowOpacity:0.12, shadowRadius:8 } }) },
